...
<?php  if (isset($images->image_intro) and !empty($images->image_intro)) : ?>
	<div class="item__img" style="background-image: url('<?php echo htmlspecialchars($images->image_intro, ENT_COMPAT, 'UTF-8'); ?>')"></div>
<?php endif; ?>
...
<?php endif; ?>
	...
	<div class="item__param">
		<?php if ($params->get('show_hits')) : ?>
			<div class="item-param__item item-param__item-views" title="<?php echo JText::sprintf('COM_CONTENT_ARTICLE_HITS', $this->item->hits); ?>"><?php echo JText::sprintf($this->item->hits); ?></div>
		<?php endif; ?>
